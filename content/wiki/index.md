...
This wiki is the **compiled** view of immutable sources under `content/sources/`. Pages are denser, cross-linked, and meant for both humans and agents.
...
Prefer wiki pages for multi-hop questions. Follow wiki-links like a graph. Sources remain the audit trail — cite them when claims matter.
